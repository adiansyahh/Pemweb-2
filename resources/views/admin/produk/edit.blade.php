...
<form method="POST" action="{{ url('admin/produk/update/'. $prod->id) }}">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="kode" name="kode" type="text" value="{{ $prod->kode }}" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="harga_beli" name="harga_beli" type="text"  value="{{ $prod->harga_beli }}" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
