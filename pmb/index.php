	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<input type="submit" name="login" value="login" class="form-control btn btn-primary submit px-3"></input>
	            </div>
...
<?php
session_start();
//apakah user sudah submit from login apa belum
if (isset($_POST['login'])){
//ambil data dari from login yang di submit oleh user
$username = $_POST['username'];
$password = $_POST['password'];

//validasi username dan password yang di submit oleh user
//lakukan perbandingan dengan nilai hard-code atau username dan passswordnya
if ($username == "admin" && $password == '12345') {
    //jika nilai username dan password yang di imputkan user sama dengan nilai yang di tentukan
